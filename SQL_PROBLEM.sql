...
CATEGORY_ID INT FOREIGN KEY REFERENCES CATEGORY(CATEGORY_ID) NOT NULL,
VALID_FROM DATETIME2 GENERATED ALWAYS AS ROW START DEFAULT '2013-01-01',
VALID_TO DATETIME2 GENERATED ALWAYS AS ROW END DEFAULT GETDATE() ,
...
---------VIEW WITH ALL CLIENTS THAT AR NOT BLOCKED AND HAVE ORDERS-------
SELECT * FROM CLIENT
SELECT * FROM ORDERS
...
RETURNS TABLE 
AS
RETURN (SELECT O.ORDER_NUMBER, P.PRODUCT_NAME, DATE_TIME 
FROM PRODUCT P JOIN ORDERS O 
ON P.PRODUCT_ID = O.PRODUCT_ID
WHERE CATEGORY_ID = @CATEGORY_ID AND DATE_TIME >= @DATE
)

DROP FUNCTION ORDER_ITEMS_ON_DATE

SELECT * FROM ORDER_ITEMS_ON_DATE(11,'2023-01-09')

SELECT * FROM PRODUCT
INSERT INTO PRODUCT
VALUES ('ZELE', 2.50, 3.30, 11)

SELECT * FROM ORDERS
INSERT INTO ORDERS
VALUES('000007',DEFAULT, 2, 3, 6, 3)

----------------------------------------------------------------------

----------------QUERY FOR PROFIT ------------

SELECT * FROM ORDERS O JOIN STATUS S ON O.STATUS_ID = S.STATUS_ID
JOIN PRODUCT P ON P.PRODUCT_ID = O.PRODUCT_ID

GO
DECLARE
@FROM_DATE DATE = '2013-01-01',
@TO_DATE DATE = GETDATE()
SELECT SUM(SALE_PRICE-DELIVERY_PRICE) AS TOTAL_PROFIT, S.STATUS_NAME, @FROM_DATE AS [FROM_DATE], @TO_DATE[TO_DATE]
FROM ORDERS O JOIN PRODUCT P
ON O.PRODUCT_ID = P.PRODUCT_ID
             JOIN STATUS S
ON O.STATUS_ID = S.STATUS_ID
WHERE S.STATUS_NAME = 'Odobreno plashtane' AND O.DATE_TIME  BETWEEN @FROM_DATE AND @TO_DATE
